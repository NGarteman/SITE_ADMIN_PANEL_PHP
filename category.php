...
<html lang="en">
<head>
	<title>AdminSL - Управление категориями</title>
	<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-md-2 navbar-container border-right" style="color:white;">
				<ul class="nav flex-column pl-1 pt-2">
					...
					<li class="nav-item">
						<a href="#" class="nav-link hvr-forward link"><i class="fas fa-sliders-h"></i> Управление категориями</a>
					</li>
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
			  <li class="nav-item">
			    <a class="nav-link active hvr-float" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i class="fas fa-table"></i> Все категории</a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link hvr-float" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="far fa-plus-square"></i> Новая категория</a>
			  </li>
			</ul>
			<!-- tab content -->
			<div class="tab-content" id="myTabContent">
			  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
				  ...
				  <thead class="table-thead table-striped">
				    <tr>
				      ...
				      <th scope="col">Количество записей в категории</th>
				  ...
				  <tbody>
				    <tr>
				      ...
				      <td>50</td>
				      <td>2019-12-12</td>
				      <td><a href="#" class="pr-2 hvr-grow" data-toggle="tooltip" data-placement="top" title="Удалить"><i class="far fa-trash-alt"></i></a> <a class="hvr-grow" href="#" data-toggle="tooltip" data-placement="top" title="Редактировать"><i class="far fa-edit"></i></a></td>
				    </tr>
				  </tbody>
				</table>
			  </div>
			  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
				  ...
				  <div class="form-group">
				    ...
				    <input name="title" type="text" class="form-control" id="categoryName">
				  </div>
				  <button type="submit" class="btn btn-primary rubik-font">Создать</button>
				</form>
				</div>
			  </div>
			</div>
