...
<form action="check.php" method="post">
    ...
    <input type="text" class="form-control" id="name" placeholder="Введите имя" name="name" required></br>
  ...
  <button type="submit" class="btn btn-primary" style="margin-left:230; width:100%;">Зарегистрироваться</button>
</form>

</br>Нажимая зарегистрироваться вы соглашаетесь с условиями пользования и политикой конфиденциальности.
